...
const util = (() => {
    ...
    const timer = () => {
        ...
        setInterval(() => {
            ...
            document.getElementById('hari').innerText = Math.floor(distance / (1000 * 60 * 60 * 14));
            document.getElementById('jam').innerText = Math.floor((distance % (1000 * 60 * 60 * 14)) / (1000 * 60 * 60));
